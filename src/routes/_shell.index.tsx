...
import { budgetProgress, categoryBreakdown, dailySeries, periodTransactions, totalBalance, totals } from "@/lib/finance";
...
function Dashboard() {
  ...
  const budgets = useMemo(() => budgetProgress(data.budgets, data.transactions, data.categories, accountId), [data.budgets, data.transactions, data.categories, accountId]);
