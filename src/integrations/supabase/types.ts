...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      add_savings_goal_contribution: { Args: { p_goal_id: string; p_amount: number; p_date?: string; p_note?: string }; Returns: Database["public"]["Tables"]["savings_goal_contributions"]["Row"] }
      update_savings_goal_contribution: { Args: { p_contribution_id: string; p_amount: number; p_date: string; p_note: string }; Returns: Database["public"]["Tables"]["savings_goal_contributions"]["Row"] }
    }
...
export type Enums<DefaultSchemaEnumNameOrOptions extends keyof DefaultSchema["Enums"] | { schema: keyof DatabaseWithoutInternals }, EnumName extends DefaultSchemaEnumNameOrOptions extends { schema: keyof DatabaseWithoutInternals } ? keyof DatabaseWithoutInternals[DefaultSchemaEnumNameOrOptions["schema"]]["Enums"] : never = never> = DefaultSchemaTableNameOrOptions extends { schema: keyof DatabaseWithoutInternals } ? DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions["schema"]]["Enums"][EnumName] : DefaultSchemaEnumNameOrOptions extends keyof DefaultSchema["Enums"] ? DefaultSchema["Enums"][DefaultSchemaEnumNameOrOptions] : never
