...
export const Route = createFileRoute("/_shell/more/budgets")({ head: () => ({ meta: [{ title: "Budgets — Paisa Expense Manager" }, { name: "description", content: "Set account-specific weekly and monthly spending limits by category." }] }), component: BudgetsPage });
