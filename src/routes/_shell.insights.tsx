...
import { budgetProgress, categoryBreakdown, dailySeries, monthlySeries, periodTransactions, projectMonth, projectionSeries, scopeTransactions, totals } from "@/lib/finance";
...
function InsightsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_auto] gap-2"><AccountSelector /><PeriodSelector /></div>
